                    ...
                    <div className="flex flex-col space-y-8 lg:sticky lg:top-32">
                        ...
                        <div className="pt-8">
                            ...
                            <div className="flex gap-4">
                                ...
                                <a className="size-10 flex items-center justify-center rounded-full bg-white border border-gray-200 hover:border-[#7f13ec] hover:text-[#7f13ec] transition-all shadow-sm hover:shadow-[0_4px_20px_-2px_rgba(127,19,236,0.1)]" href="https://www.instagram.com/arkanaweb?igsh=NDVlenptcjFsZDFh" >
