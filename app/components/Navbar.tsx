            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-20 items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-1">
                        ...
                        <Link className="px-4 py-2 text-sm font-medium text-slate-500 hover:text-[#7f13ec] transition-colors" href="/about">About</Link>
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden border-t border-slate-100 bg-white">
                    <div className="px-4 py-4 space-y-2 flex flex-col">
                        ...
                        <Link className="px-4 py-2 text-sm font-medium text-slate-500 hover:text-[#7f13ec] transition-colors" href="/about" onClick={() => setIsMobileMenuOpen(false)}>About</Link>
