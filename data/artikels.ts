export const artikels = [
    {
        ...
        date: "28 Juni 2026",
        category: "teknologi",
        description: "Tentang Hosting & Domain.",
        content: `1. Domain: Alamat Rumah Anda di Internet


Secara teknis, setiap server atau komputer yang terhubung ke internet diidentifikasi melalui deretan angka rumit yang disebut IP Address (contoh: 192.168.1.1). Masalahnya, memori manusia tidak dirancang untuk mengingat angka-angka rumit tersebut setiap kali ingin mengunjungi sebuah website.

Di sinilah Domain Name System (DNS) penyelamatnya.

Domain (seperti vivideditorial.com) bertindak sebagai penunjuk arah yang ramah pengguna. Ia mengubah koordinat digital yang rumit menjadi sebuah identitas atau brand yang mudah diingat dan diketik.
